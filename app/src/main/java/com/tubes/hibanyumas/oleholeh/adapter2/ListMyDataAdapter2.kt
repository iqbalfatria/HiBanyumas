package com.tubes.hibanyumas.oleholeh.adapter2
...
import com.tubes.hibanyumas.oleholeh.OlehDetailActivity
import kotlinx.android.synthetic.main.item_list_recycle_view.view.*

class ListMyDataAdapter2(private val listMyData: ArrayList<MyData>, val context: Context) :
    RecyclerView.Adapter<ListMyDataAdapter2.ListViewHolder>() {
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(myData: MyData) {
            ...
            itemView.setOnClickListener {
                val moveWithObjectIntent = Intent(context, OlehDetailActivity::class.java)
                moveWithObjectIntent.putExtra(OlehDetailActivity.EXTRA_MYDATA, myData)
