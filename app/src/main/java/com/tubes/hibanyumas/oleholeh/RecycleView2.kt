package com.tubes.hibanyumas.oleholeh
...
class RecycleView2 : AppCompatActivity() {
    ...
    fun getListMyDatas(): ArrayList<MyData> {
        ...
        val dataPhoto = resources.getStringArray(R.array.data_photo2)
    ...
    private fun showRecyclerList() {
        ...
        val listMyDataAdapter = ListMyDataAdapter(list, this@RecycleView2)
