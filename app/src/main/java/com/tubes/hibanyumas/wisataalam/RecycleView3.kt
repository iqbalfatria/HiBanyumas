package com.tubes.hibanyumas.wisataalam
...
import com.tubes.hibanyumas.wisataalam.adapter3.ListMyDataAdapter3
...
class RecycleView3 : AppCompatActivity() {
    ...
    private fun showRecyclerList() {
        rv_mydata3.layoutManager = LinearLayoutManager(this)
        val listMyDataAdapter = ListMyDataAdapter3(list, this@RecycleView3)
        rv_mydata3.adapter = listMyDataAdapter
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rv_mydata3.setHasFixedSize(true)
